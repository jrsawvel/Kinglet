...
my $dispatch_for = {
    ...
    requestapproval    =>   sub { return \&do_sub(       "Approval",       "request_approval"         ) },
    requestsreceived   =>   sub { return \&do_sub(       "Approval",       "show_requests_received"   ) },
    approverequest     =>   sub { return \&do_sub(       "Approval",       "approve_request"          ) },
    rejectrequest      =>   sub { return \&do_sub(       "Approval",       "reject_request"           ) },
};
