...
# m_get-stream-get.t
# get all of a user's messages and replies that were sent and received
...
ok($rc >= 200 && $rc < 300 , 'retrieving all messages and replies that were sent and received for a user was successful.');
